...
class EmergencyAdapter(private val emergencies: List<Emergency>, private val clickListener: EmergencyClickListener)
    : RecyclerView.Adapter<EmergencyViewHolder>()
{
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EmergencyViewHolder {
        ...
        return EmergencyViewHolder(binding, clickListener)
    }
